...
export const PRODUCTS: Product[] = [
  ...
  ========================= */
  {
    ...
    specs: [
      ...
      "Placa Gigabyte B760M E DDR5 LGA1700",
      "RAM Corsair Vengeance DDR5 5200MHz 16GB (2x8GB)",
      "SSD Kingston NV3 NVMe PCIe 4.0 1TB",
      "Disipador Tempest Cooler 4Pipes 120mm",
      "Caja MSI MAG Forge M100R RGB",
  ...
  ========================= */
  {
    ...
    specs: [
      ...
      "Placa ASUS PRIME B850M-A WIFI AM5 DDR5",
      "RAM Corsair Vengeance RGB DDR5 6000MHz 32GB (2x16GB)",
      "SSD Kingston NV3 NVMe PCIe 4.0 1TB",
      "RL Corsair Nautilus 360 RS ARGB",
      "Caja MSI MAG Forge M100R RGB",
      "Fuente Corsair RM850e 850W 80+ Gold Modular",
    ],
    longDesc: [
  ...
  ========================= */
  {
    ...
    specs: [
      ...
      "CPU AMD Ryzen 7 9800X3D 5.2GHz",
      "Placa ASUS PRIME B850M-A WIFI AM5 DDR5",
      "RAM Corsair Vengeance RGB DDR5 6000MHz 64GB (2x32GB)",
      "SSD Samsung 990 EVO Plus 2TB NVMe PCIe 4.0",
      "RL Corsair Nautilus 360 RS ARGB",
      "Caja Corsair 3500X LX-R RGB iCUE LINK semitorre",
      "Fuente Corsair RM850e 850W 80+ Gold Modular",
    ],
    longDesc: [

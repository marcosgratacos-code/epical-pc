...
export default function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-xl border border-white/20 bg-white px-4 py-2 text-sm font-semibold text-black hover:bg-white/90 focus:outline-none focus:ring-2 focus:ring-violet-400"
    >
